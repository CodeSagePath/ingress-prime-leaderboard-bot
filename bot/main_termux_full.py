...
# uvicorn removed for Termux compatibility
...
# dashboard import removed for Termux compatibility
...
async def build_application() -> Application:
    ...
    async def on_start(app: Application) -> None:
        scheduler.start()
        # Dashboard functionality removed for Termux compatibility
    async def on_stop(app: Application) -> None:
        # Dashboard cleanup removed for Termux compatibility
